...
#define RC_CH1_INPUT  20 // receiver pin 1
#define RC_CH2_INPUT  21 // receiver pin 2
#define RC_CH3_INPUT  18 // receiver pin 3
#define RC_CH4_INPUT  19 // receiver pin 4
#define RC_CH6_INPUT  16 // receiver pin 3
#define RC_CH8_INPUT  17 // receiver pin 4
