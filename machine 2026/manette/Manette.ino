...
#define RC_CH4_INPUT  19 // receiver pin 4
#define RC_CH3_INPUT  20 // receiver pin 
#define RC_CH2_INPUT  21 // receiver pin 
...
void setup() {
  ...
  myservo1.attach(15); // Use PWM pin 15 to control Sabertooth.
}
...
void loop() {
  ...
  Serial.print(store); Serial.print(", "); Serial.println(store1);
  delay(50);
}
